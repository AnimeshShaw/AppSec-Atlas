      ...
      links: [
        {
          ...
          items: [
            ...
            { label: 'Post-Quantum Crypto', to: '/docs/foundational/post-quantum-cryptography' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Modern API Identity', to: '/docs/web-and-api/modern-api-identity' },
            { label: 'Cloud Security', to: '/docs/cloud-and-infra/cloud-security' },
            { label: 'Cross-Cloud IAM', to: '/docs/cloud-and-infra/cross-cloud-iam-federation' },
            { label: 'Kubernetes eBPF', to: '/docs/cloud-and-infra/kubernetes-ebpf-runtime' },
            { label: 'Zero-Day Playbooks', to: '/docs/cloud-and-infra/cloud-zero-day-playbooks' },
          ],
        },
        {
          title: 'AI, Offensive & Defensive',
          items: [
            ...
            { label: 'Enterprise Security', to: '/docs/offensive/enterprise-security-assessment' },
            { label: 'Bug Bounty Guide', to: '/docs/offensive/bug-bounty' },
            { label: 'Chaos Engineering', to: '/docs/defensive/security-chaos-engineering' },
            { label: 'Supply Chain (SLSA)', to: '/docs/specialized/supply-chain-security' },
          ],
        },
        {
