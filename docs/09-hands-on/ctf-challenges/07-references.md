...
5. **TerraGoat**
   ...
   - [GitHub Repository](https://github.com/bridgecrewio/terragoat)

## CTF Platforms
To practice against real-world scenarios in a competitive environment:
- **[CTFtime](https://ctftime.org/)**: The central hub for tracking global Capture The Flag competitions.
- **[Hack The Box](https://www.hackthebox.com/)**: A massive platform for penetration testing labs and CTF challenges.
- **[TryHackMe](https://tryhackme.com/)**: Excellent guided learning paths for beginners.
- **[PortSwigger Web Security Academy](https://portswigger.net/web-security)**: Free, interactive labs focused on web vulnerabilities (creators of Burp Suite).
