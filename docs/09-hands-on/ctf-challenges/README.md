...
- [01 Introduction & Setup](./01-introduction.md): Setting up the vulnerable lab environment.
- [02 Web Vulnerabilities Lab](./02-web-vulnerabilities-lab.md): Challenges for traditional web flaws (SQLi, XSS, SSRF, etc.).
- [03 API Vulnerabilities Lab](./03-api-vulnerabilities-lab.md): Challenges targeting REST and GraphQL APIs.
- [04 AI & ML Vulnerabilities Lab](./04-ai-ml-vulnerabilities-lab.md): Novel attacks against LLMs and RAG systems.
- [05 Cloud & IaC Vulnerabilities Lab](./05-cloud-iac-vulnerabilities-lab.md): Misconfigurations in Docker and Terraform.
- [06 Hands-on Full Stack Lab](./06-hands-on-lab.md): A comprehensive, multi-stage vulnerable application.
- [07 References](./07-references.md): Additional resources and external labs for further practice.
