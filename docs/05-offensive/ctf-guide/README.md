...
CTFs are not just games—they are the gold standard for hands-on, practical cybersecurity education. By participating in CTFs, you simulate real-world attacks and defenses in a safe, legal environment.
...
- **[01. Introduction](./01-introduction.md)** - CTF theory, formats, and categories.
- **[02. Web and Crypto Tactics](./02-web-and-crypto-ctf-tactics.md)** - Deep dive into Web exploitation and Cryptography attacks.
- **[03. Reverse Engineering & Pwn](./03-rev-and-pwn-ctf-tactics.md)** - Tackling binary exploitation and dissecting executables.
- **[04. Forensics and Steganography](./04-forensics-and-stego-ctf-tactics.md)** - Memory, PCAP analysis, and finding hidden data.
- **[05. Tooling and Environment](./05-ctf-tooling-and-environment.md)** - Setting up your hacker workspace.
- **[06. Hands-On Lab](./06-hands-on-lab.md)** - A runnable SSTI challenge with exploit and remediation scripts.
- **[07. References](./07-references.md)** - External resources, platforms, and documentation.
