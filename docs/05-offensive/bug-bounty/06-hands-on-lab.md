...
description: In this hands-on lab, you will audit a **vulnerable Coupon Redemption
  API**, run an audit script to detect a Race Condition flaw, and implement an ato...
keywords:
- AppSec
- Cybersecurity
- Security
...
- Lab
- Md
slug: /offensive/bug-bounty/hands-on-lab
---
